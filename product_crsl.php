<div id="carouselExampleDark<?= $c_id ?>" class="carousel carousel-dark slide p-2" data-bs-ride="carousel">
    <div class="carousel-inner ">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleDark<?= $c_id ?>" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDark<?= $c_id ?>" data-bs-slide="next">
